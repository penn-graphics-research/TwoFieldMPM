...
pressureGradients = [0, 0, 0, 0, 1]        #Pressure Gradient Tests [30 Diameter Pipe, 30 Diameter Pipe with Clot, with clot and Dirichlet pipe walls, Dirichlet walls w/o clot, Dam Break Test (Zhao2022 to test FBar)]
