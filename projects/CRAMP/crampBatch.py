...
paper1Tests = [1, 0, 0, 0]              #[SENT with const width crack and variable dx for 1F MPM, then with 2F MPM, Hole in Plate with SF, Hole in Plate with TF]
...
if sectorE[0]:
    if paper1Tests[0]:
        dxArray = [0.00008, 0.0001, 0.0002, 0.0003]
