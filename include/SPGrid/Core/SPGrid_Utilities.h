...
[[ noreturn ]] void Fatal_Error(const char* function,const char* file,int line);
[[ noreturn ]] void Fatal_Error(const char* function,const char* file,int line,const char* message);
[[ noreturn ]] void Fatal_Error(const char* function,const char* file,int line,const std::string& message);
