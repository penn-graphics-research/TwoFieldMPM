...
int baseNode(const T& x);
template <int interpolation_degree, class T, int dim>
Vector<int, dim> baseNode(const Vector<T, dim>& x);
template <class T>
void computeBSplineWeights(const T x, int& base_node, Vector<T, 1>& w, Vector<T, 1>* dw = 0, Vector<T, 1>* ddw = 0);
template <class T>
void computeBSplineWeights(const T x, int& base_node, Vector<T, 2>& w, Vector<T, 2>* dw = 0, Vector<T, 2>* ddw = 0);
template <class T>
void computeBSplineWeights(const T x, int& base_node, Vector<T, 3>& w, Vector<T, 3>* dw = 0, Vector<T, 3>* ddw = 0);
template <class T>
void computeBSplineWeights(const T x, int& base_node, Vector<T, 4>& w, Vector<T, 4>* dw = 0, Vector<T, 4>* ddw = 0);
