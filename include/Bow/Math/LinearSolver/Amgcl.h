...
public:
    ...
    Bow::Vector<typename Derived::Scalar, Eigen::Dynamic> solve(const Bow::Vector<typename Derived::Scalar, Eigen::Dynamic>& rhs) const;
    // TODO: Separate CUDA-version compute and solve will cause memory leak in GPU.
    Bow::Vector<typename Derived::Scalar, Eigen::Dynamic> solve(const Eigen::SparseMatrixBase<Derived>& mat, const Bow::Vector<typename Derived::Scalar, Eigen::Dynamic>& rhs);
};
}
}
